...
#ifndef GOOGLE_PROTOBUF_INCLUDED_Task_5f2_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_Task_5f2_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_Task_5f2_2eproto
...
struct TableStruct_Task_5f2_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_Task_5f2_2eproto;
namespace Task_2 {
class FullName;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::Task_2::FullName* Arena::CreateMaybeMessage<::Task_2::FullName>(Arena*);
template<> ::Task_2::Student* Arena::CreateMaybeMessage<::Task_2::Student>(Arena*);
template<> ::Task_2::StudentsGroup* Arena::CreateMaybeMessage<::Task_2::StudentsGroup>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace Task_2 {
...
class FullName PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Task_2.FullName) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_Task_5f2_2eproto);
    return ::descriptor_table_Task_5f2_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  // @@protoc_insertion_point(class_scope:Task_2.FullName)
 private:
  class _Internal;
  ...
  friend struct ::TableStruct_Task_5f2_2eproto;
};
// -------------------------------------------------------------------

class Student PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Task_2.Student) */ {
 public:
  ...
  public:
  void clear_name();
  const ::Task_2::FullName& name() const;
  ::Task_2::FullName* release_name();
  ::Task_2::FullName* mutable_name();
  void set_allocated_name(::Task_2::FullName* name);
  private:
  const ::Task_2::FullName& _internal_name() const;
  ::Task_2::FullName* _internal_mutable_name();
  public:
  void unsafe_arena_set_allocated_name(
      ::Task_2::FullName* name);
  ::Task_2::FullName* unsafe_arena_release_name();
  ...
  // @@protoc_insertion_point(class_scope:Task_2.Student)
 private:
  class _Internal;
...
class StudentsGroup PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Task_2.StudentsGroup) */ {
 public:
  ...
  public:
  void clear_students();
  ::Task_2::Student* mutable_students(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Task_2::Student >*
      mutable_students();
  private:
  const ::Task_2::Student& _internal_students(int index) const;
  ::Task_2::Student* _internal_add_students();
  public:
  const ::Task_2::Student& students(int index) const;
  ::Task_2::Student* add_students();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Task_2::Student >&
      students() const;

  // @@protoc_insertion_point(class_scope:Task_2.StudentsGroup)
 private:
  class _Internal;
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Task_2::Student > students_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_Task_5f2_2eproto;
};
// ===================================================================
...
inline const std::string& FullName::name() const {
  // @@protoc_insertion_point(field_get:Task_2.FullName.name)
  return _internal_name();
}
inline void FullName::set_name(const std::string& value) {
  _internal_set_name(value);
  // @@protoc_insertion_point(field_set:Task_2.FullName.name)
}
inline std::string* FullName::mutable_name() {
  // @@protoc_insertion_point(field_mutable:Task_2.FullName.name)
...
inline void FullName::set_name(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:Task_2.FullName.name)
}
inline void FullName::set_name(const char* value) {
  ...
  name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:Task_2.FullName.name)
}
inline void FullName::set_name(const char* value,
    size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:Task_2.FullName.name)
}
...
inline std::string* FullName::release_name() {
  // @@protoc_insertion_point(field_release:Task_2.FullName.name)
...
inline void FullName::set_allocated_name(std::string* name) {
  ...
  name_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), name,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:Task_2.FullName.name)
}
...
inline const std::string& FullName::surname() const {
  // @@protoc_insertion_point(field_get:Task_2.FullName.surname)
  return _internal_surname();
}
inline void FullName::set_surname(const std::string& value) {
  _internal_set_surname(value);
  // @@protoc_insertion_point(field_set:Task_2.FullName.surname)
}
inline std::string* FullName::mutable_surname() {
  // @@protoc_insertion_point(field_mutable:Task_2.FullName.surname)
...
inline void FullName::set_surname(std::string&& value) {
  ...
  surname_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:Task_2.FullName.surname)
}
inline void FullName::set_surname(const char* value) {
  ...
  surname_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:Task_2.FullName.surname)
}
inline void FullName::set_surname(const char* value,
    size_t size) {
  ...
  surname_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:Task_2.FullName.surname)
}
...
inline std::string* FullName::release_surname() {
  // @@protoc_insertion_point(field_release:Task_2.FullName.surname)
...
inline void FullName::set_allocated_surname(std::string* surname) {
  ...
  surname_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), surname,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:Task_2.FullName.surname)
}
...
inline const std::string& FullName::patronymic() const {
  // @@protoc_insertion_point(field_get:Task_2.FullName.patronymic)
  return _internal_patronymic();
}
inline void FullName::set_patronymic(const std::string& value) {
  _internal_set_patronymic(value);
  // @@protoc_insertion_point(field_set:Task_2.FullName.patronymic)
}
inline std::string* FullName::mutable_patronymic() {
  // @@protoc_insertion_point(field_mutable:Task_2.FullName.patronymic)
...
inline void FullName::set_patronymic(std::string&& value) {
  ...
  patronymic_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:Task_2.FullName.patronymic)
}
inline void FullName::set_patronymic(const char* value) {
  ...
  patronymic_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:Task_2.FullName.patronymic)
}
inline void FullName::set_patronymic(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000001u;
  patronymic_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:Task_2.FullName.patronymic)
}
...
inline std::string* FullName::release_patronymic() {
  // @@protoc_insertion_point(field_release:Task_2.FullName.patronymic)
...
inline void FullName::set_allocated_patronymic(std::string* patronymic) {
  ...
  patronymic_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), patronymic,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:Task_2.FullName.patronymic)
}
...
inline const ::Task_2::FullName& Student::_internal_name() const {
  const ::Task_2::FullName* p = name_;
  return p != nullptr ? *p : *reinterpret_cast<const ::Task_2::FullName*>(
      &::Task_2::_FullName_default_instance_);
}
inline const ::Task_2::FullName& Student::name() const {
  // @@protoc_insertion_point(field_get:Task_2.Student.name)
  return _internal_name();
}
inline void Student::unsafe_arena_set_allocated_name(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:Task_2.Student.name)
}
inline ::Task_2::FullName* Student::release_name() {
  
  ::Task_2::FullName* temp = name_;
  name_ = nullptr;
  if (GetArena() != nullptr) {
...
inline ::Task_2::FullName* Student::unsafe_arena_release_name() {
  // @@protoc_insertion_point(field_release:Task_2.Student.name)
  
  ::Task_2::FullName* temp = name_;
  name_ = nullptr;
  return temp;
}
inline ::Task_2::FullName* Student::_internal_mutable_name() {
  
  if (name_ == nullptr) {
    auto* p = CreateMaybeMessage<::Task_2::FullName>(GetArena());
    name_ = p;
  }
  return name_;
}
inline ::Task_2::FullName* Student::mutable_name() {
  // @@protoc_insertion_point(field_mutable:Task_2.Student.name)
  return _internal_mutable_name();
}
inline void Student::set_allocated_name(::Task_2::FullName* name) {
  ...
  name_ = name;
  // @@protoc_insertion_point(field_set_allocated:Task_2.Student.name)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 Student::grades(int index) const {
  // @@protoc_insertion_point(field_get:Task_2.Student.grades)
...
inline void Student::set_grades(int index, ::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:Task_2.Student.grades)
}
...
inline void Student::add_grades(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_add:Task_2.Student.grades)
}
...
Student::grades() const {
  // @@protoc_insertion_point(field_list:Task_2.Student.grades)
...
Student::mutable_grades() {
  // @@protoc_insertion_point(field_mutable_list:Task_2.Student.grades)
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 Student::avg_score() const {
  // @@protoc_insertion_point(field_get:Task_2.Student.avg_score)
...
inline void Student::set_avg_score(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:Task_2.Student.avg_score)
}
...
inline ::Task_2::Student* StudentsGroup::mutable_students(int index) {
  // @@protoc_insertion_point(field_mutable:Task_2.StudentsGroup.students)
  return students_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Task_2::Student >*
StudentsGroup::mutable_students() {
  // @@protoc_insertion_point(field_mutable_list:Task_2.StudentsGroup.students)
  return &students_;
}
inline const ::Task_2::Student& StudentsGroup::_internal_students(int index) const {
  return students_.Get(index);
}
inline const ::Task_2::Student& StudentsGroup::students(int index) const {
  // @@protoc_insertion_point(field_get:Task_2.StudentsGroup.students)
  return _internal_students(index);
}
inline ::Task_2::Student* StudentsGroup::_internal_add_students() {
  return students_.Add();
}
inline ::Task_2::Student* StudentsGroup::add_students() {
  // @@protoc_insertion_point(field_add:Task_2.StudentsGroup.students)
  return _internal_add_students();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Task_2::Student >&
StudentsGroup::students() const {
  // @@protoc_insertion_point(field_list:Task_2.StudentsGroup.students)
  return students_;
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_Task_5f2_2eproto
